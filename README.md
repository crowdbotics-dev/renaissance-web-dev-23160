...
## Project Structure
    ...
    ├── renaissance_web_dev_23160  # Django project configurations
...
1. Clone this repo and `cd renaissance_web_dev_23160`
...
2. Clone this repo and `cd renaissance_web_dev_23160`
